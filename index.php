...
<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="images/icons/cpf2.png"/>
<!--===============================================================================================-->
				...
				<div>
					<?php
						if(isset($_POST['btn'])){
							...
							if(ValidarCpf($_POST['cpf']) == true){
							echo "<br/><br/><span style='color:green';><b><big>SUCESSO! &#128525 CPF VERDADEIRO &#128525</b></big></span>";
							}
							else{
								echo "<br/><br/><span style='color:red';><b><big>QUE PENA! &#128557 CPF FALSO 	&#128557</b></big></span>";
							}
						}   
					?>
				</div>
